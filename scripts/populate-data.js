// Firestore data population script using REST API
  ...
  listings: [
    {
      ...
      catchDate: new Date(Date.now() - 86400000).toISOString(), // Yesterday
      expiryDate: new Date(Date.now() + 172800000).toISOString(), // +48 hours
      location: {
    ...
    },
    {
      ...
      catchDate: new Date(Date.now() - 43200000).toISOString(), // 12 hours ago
      expiryDate: new Date(Date.now() + 259200000).toISOString(), // +72 hours
      location: {
        address: "123 Fisherman's Wharf, San Francisco, CA",
        lat: 37.8080,
        lng: -122.4177
    ...
    },
    {
      ...
      catchDate: new Date(Date.now() - 172800000).toISOString(), // 2 days ago
      expiryDate: new Date(Date.now() + 345600000).toISOString(), // +4 days
      location: {
    ...
    },
    {
      ...
      catchDate: new Date(Date.now() - 129600000).toISOString(), // 1.5 days ago
    ...
    },
    {
      ...
      catchDate: new Date(Date.now() - 259200000).toISOString(), // 3 days ago
      expiryDate: new Date(Date.now() + 604800000).toISOString(), // +7 days
      location: {
        address: "123 Fisherman's Wharf, San Francisco, CA",
        lat: 37.8080,
        lng: -122.4177
    ...
    },
    {
      ...
      catchDate: new Date(Date.now() - 21600000).toISOString(), // 6 hours ago
      expiryDate: new Date(Date.now() + 86400000).toISOString(), // +24 hours
      location: {
        address: "456 Pier 55, Seattle, WA",
        lat: 47.6046,
    ...
    },
    {
      ...
      catchDate: new Date(Date.now() - 345600000).toISOString(), // 4 days ago
      expiryDate: new Date(Date.now() + 172800000).toISOString(), // +48 hours
      location: {
        address: "123 Fisherman's Wharf, San Francisco, CA",
        lat: 37.8080,
    ...
    },
    {
      ...
      catchDate: new Date(Date.now() - 604800000).toISOString(), // 1 week ago
      expiryDate: new Date(Date.now() + 1209600000).toISOString(), // +2 weeks
      location: {
        address: "456 Pier 55, Seattle, WA",
        lat: 47.6046,
        lng: -122.3388
...
console.log(`- ${sampleData.users.length} users (vendors and buyers)`);
console.log(`- ${sampleData.listings.length} listings (various seafood)`);
console.log("\nTo populate production database, run:");
console.log("  gcloud firestore documents write \"users/vendor-pacific-catch\" ...");
console.log("\nOr use the Firebase Admin SDK with proper credentials.");
